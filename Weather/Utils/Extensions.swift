...
//  Weather
//
//  Created by Bruno Henrique Ferraz da Silva on 26/04/25.
//
...
extension Color {
    ...
    static let tabBarBorders = Color("Tab Bar Border").opacity(0.5)

    static let forecastCardBackgrounds = Color("Forecast Card Background")

    static let probabilityTexts = Color("Probability Text")
}
